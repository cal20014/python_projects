...
def sublist_sort(array):
    ...
    while not is_sorted:
        ...
        while start_index < len(array):
            ...
            # Adjust if the second subarray is beyond the array length
            if end_of_subarray02 > len(array):
                end_of_subarray02 = len(array)
            
            if end_of_subarray01 < len(array):
                merge_sorted_subarrays(sourceArray01, start_index, end_of_subarray01, end_of_subarray02, sourceArray02)
